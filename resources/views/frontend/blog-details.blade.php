                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog-meta two mb-50">
                        <div class="author-area">
                            ...
                            <div class="author-content">
                                <h6>By, <a href="blog-grid.blade.php">Cooper Jogan</a></h6>
                            </div>
                        </div>
                        <ul>
                            <li>
                    ...
                    <div class="tag-and-social-area mb-30">
                        <div class="bolg-tag">
                            <ul class="tag-list">
                                <li>
                                    <a href="blog-grid.blade.php ">Adventure</a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">City Tour</a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">Road Trip </a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">Tourism</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget mb-30">
                            ...
                            <div class="recent-post-widget mb-20">
                                <div class="recent-post-img">
                                    <a href="blog-details.html"><img src="assets/img/innerpage/recent-post-img1.png" alt=""></a>
                                </div>
                                <div class="recent-post-content">
                                    <a href="blog-grid.blade.php">20 July, 2023</a>
                                    <h6><a href="blog-details.html">Poutsicle Hydrating Lipo Stain offering.</a></h6>
                                </div>
                            </div>
                            <div class="recent-post-widget mb-20">
                                <div class="recent-post-img">
                                    <a href="blog-details.html"><img src="assets/img/innerpage/recent-post-img2.png" alt=""></a>
                                </div>
                                <div class="recent-post-content">
                                    <a href="blog-grid.blade.php">12 July, 2023</a>
                                    <h6><a href="blog-details.html">rutrum vitae augue idel euismod pulvi.</a></h6>
                                </div>
                            </div>
                            <div class="recent-post-widget mb-20">
                                <div class="recent-post-img">
                                    <a href="blog-details.html"><img src="assets/img/innerpage/recent-post-img3.png" alt=""></a>
                                </div>
                                <div class="recent-post-content">
                                    <a href="blog-grid.blade.php">04 July, 2023</a>
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="tag-list">
                                ...
                                <li>
                                    <a href="blog-grid.blade.php ">Wildlife </a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">Nature Excursion</a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">Photography</a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">Cruise</a>
                                </li>
                                <li>
                                    <a href="blog-grid.blade.php ">Cultural</a>
                                </li>
                            </ul>
                        </div>
                    </div>
